...
## contains(...)
`def contains`(<details><summary>`...`</summary>
```python
...
## get(...)
`def get`(<details><summary>`...`</summary>
```python
...
## items_full(...)
`def items_full`(<details><summary>`...`</summary>
```python
...
## key(...)
`@classmethod
def key`(<details><summary>`...`</summary>
```python
...
## keys(...)
`def keys`(<details><summary>`...`</summary>
```python
...
## mass_set_default(...)
`def mass_set_default`(<details><summary>`...`</summary>
```python
...
## set_default(...)
`def set_default`(<details><summary>`...`</summary>
```python
...
## setitem(...)
`def setitem`(<details><summary>`...`</summary>
```python
...
## writeback(...)
`def writeback`(<details><summary>`...`</summary>
```python
...
## lang_to_pattern(...)
`def lang_to_pattern`(<details><summary>`...`</summary>
```python
...
## register_callback(...)
`def register_callback`(<details><summary>`...`</summary>
```python
...
## append(...)
`@staticmethod
def append`(<details><summary>`...`</summary>
```python
    self, object
```
</details>)
...
## count(...)
`@staticmethod
def count`(<details><summary>`...`</summary>
```python
    self, value
```
</details>)
...
## extend(...)
`@staticmethod
def extend`(<details><summary>`...`</summary>
```python
    self, iterable
```
</details>)
...
## ijoin(...)
`@staticmethod
def ijoin`(<details><summary>`...`</summary>
```python
    self, tellraws: tuple
```
</details>)` -> Generator`
...
## index(...)
`@staticmethod
def index`(<details><summary>`...`</summary>
```python
    self, value, start=0,
...
## insert(...)
`@staticmethod
def insert`(<details><summary>`...`</summary>
```python
    self, index, object
```
</details>)
...
## itell(...)
`@classmethod
def itell`(<details><summary>`...`</summary>
```python
...
## join(...)
`@staticmethod
def join`(<details><summary>`...`</summary>
```python
    self, tellraws: tuple
```
</details>)` -> Self`
...
## line_break(...)
`@staticmethod
def line_break`(<details><summary>`...`</summary>
```python
    self, count: int = 1
```
</details>)
...
## pop(...)
`@staticmethod
def pop`(<details><summary>`...`</summary>
```python
    self, index=-1
```
</details>)
...
## remove(...)
`@staticmethod
def remove`(<details><summary>`...`</summary>
```python
    self, value
```
</details>)
...
## sort(...)
`@staticmethod
def sort`(<details><summary>`...`</summary>
```python
...
## text(...)
`@staticmethod
def text`(<details><summary>`...`</summary>
```python
...
## compose_command(...)
`def compose_command`(<details><summary>`...`</summary>
```python
...
## help(...)
`def help`(<details><summary>`...`</summary>
```python
...
## helpcmd_for(...)
`def helpcmd_for`(<details><summary>`...`</summary>
```python
...
## register(...)
`def register`(<details><summary>`...`</summary>
```python
...
## register_func(...)
`def register_func`(<details><summary>`...`</summary>
```python
...
## run_command(...)
`def run_command`(<details><summary>`...`</summary>
```python
...
## tell(...)
`@staticmethod
def tell`(<details><summary>`...`</summary>
```python
...
## tellraw(...)
`@staticmethod
def tellraw`(<details><summary>`...`</summary>
```python
